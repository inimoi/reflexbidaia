...
from ..utils.utils import diados_description, diados_meta, diados_title, lang
...
@rx.page(
    route=Routes.DIADOS.value,
    title=diados_title,
    description=diados_description,
    meta=diados_meta,
    on_load=LoginState.validate_token_app
)
def diados() -> rx.Component:
    # Welcome Page (diauno)
